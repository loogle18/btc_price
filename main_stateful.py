...
# Input layer
model.add(LSTM(90, activation=activ, return_sequences=True, stateful=True, batch_input_shape=(1, n_per_in, n_features)))
...
for i in range(epochs):
    model.fit(X, y, epochs=1, batch_size=1, validation_split=0.2, callbacks=[tboard_callback], shuffle=False)
    model.reset_states()
